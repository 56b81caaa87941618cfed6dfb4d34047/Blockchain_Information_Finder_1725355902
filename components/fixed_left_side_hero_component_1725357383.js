                ...
                <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20 flex-1" id="quote-header">
                    <div class="grow flex flex-col justify-center" id="quote-content">
                        <div class="space-y-3" id="quote-container">
                            <div id="quote-title" class="font-caveat text-3xl text-blue-500">Discover the Future of Blockchain</div>
                            <h1 id="company-name" class="h1 font-orbiter font-bold text-white">BlockScan: Your Gateway to New Blockchain Insights</h1>
                            <time id="quote-date" class="block font-caveat text-xl text-slate-400">Stay ahead of the curve with real-time updates on emerging blockchain technologies, projects, and trends</time>
                        </div>
                    </div>
                </div>
            </div>
